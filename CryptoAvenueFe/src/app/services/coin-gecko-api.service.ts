...
export class CoinGeckoApiService {
  ...
  getTrendingCurrency(currency: string){
    return this.http.get<any>(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=${currency}&order=gecko_desc&per_page=8&page=1&sparkline=false&price_change_percentage=24h`);
  }
